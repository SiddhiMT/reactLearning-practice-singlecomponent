    ...
    return (
      <Fragment>
        ...
        <div className='counters'>
          <div className='redCounter'>{this.colorCounter('red')}</div>
          <div className='greenCounter'>{this.colorCounter('green')}</div>
          <div className='blueCounter'>{this.colorCounter('blue')}</div>
        </div>
    </Fragment>
    );
  }
